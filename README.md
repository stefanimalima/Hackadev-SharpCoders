# Projeto Final Sharp Coders - Hackadev 👩‍💻
...
### Task 1 | Planejamento | Objetivo -> Preparar o time para o desafio e estruturar os próximos passos para a etapa de frontend estático.
...
### Task 2 | Front-end | Objetivo -> Construir o front-end estático da aplicação.
...
- Criei a identindade visual do grupo, juntamente com a [Carolina Castilhos](https://github.com/carolinacastilhos);
- Criei o Logotipo da ImaPay;
- Forneci a estrutura inicial do HTML para as telas iniciais;
- Contribui com a estilização com CSS.

### Task 3 | React JS | Objetivo -> Migrar as telas construidas na etapa anterior para ReactJS e construir novas telas (saldo, transferência e histórico de transações).
...
### Task 4 | Conclusão | Objetivo -> Construir o back-end da aplicação e integrar com o front-end.
